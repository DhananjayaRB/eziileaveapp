...
interface Props {
  ...
  removeBadge: (item: string, category: string) => void;
  onSubmit: () => void;
  onDiscard: () => void;
  isLoading: boolean;
}
...
export function RoleForm({
  ...
  const isMatrix =
    organisationStructure?.configs.category_name === "Matrix Organisation";
