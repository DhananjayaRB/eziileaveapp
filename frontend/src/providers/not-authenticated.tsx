...
export function NotAuthenticated() {
  const handleDevelopmentClick = () => {
    const tokenData = {
      ...
      token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJvcmdfaWQiOiI2MyIsInVzZXJfaWQiOiIxIiwicm9sZV9pZCI6IjI4OSIsInVzZXJfdHlwZV9pZCI6IjMiLCJuYmYiOjE3MzYxNTUxMTUsImV4cCI6MTczNjc1NTExNSwiaXNzIjoiaHR0cHM6Ly9sb2NhbGhvc3Q6NTAwMyIsImF1ZCI6Imh0dHBzOi8vbG9jYWxob3N0OjUwMDMifQ.S-UEx8v-hQ32y7wcYSqvesmKTx2xFzAtvKz46u-HqUw",
    };
